...
class CreateHtml:
    def __init__(self):
        ...
        self.index_template = r'./static/py_html/index.html'
        self.movies_dir = r'./static/Movies/'
        self.tools_dir = r'./static/Tools/'
    ...
    def html_menu(self, movie_name):
        ...
        for mp4_name in movie_name:
            ...
            file_path = r"										<li><a href= '.\Movies\{0}' target='_blank'>{1}</a></li>".format(
                mp4_name, mp4_name_s)
    ...
    def html_tools(self, tools_name):
        ...
        for tool_name in tools_name:
            ...
            file_path = r"										<div class='agile_activity_row'><div class='a" \
                        r"gile_activity_img'><div class= 'agile_activity_sub'><h5><a href='.\Tools\{0}'>{1}</" \
                        r"a></h5></div></div><div class='clear'> </div></div>".format(tool_name, tool_name_s)
